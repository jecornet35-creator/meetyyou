...
export default function Likes() {
  ...
  const { data: notifications = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return base44.entities.Notification.filter({ user_email: currentUser.email, type: 'like' }, '-created_date', 200);
    },
    initialData: [],
  });
  ...
  useEffect(() => {
    ...
    const unsubscribe = base44.entities.Notification.subscribe((event) => {
      if (event.data?.user_email === user.email && event.data?.type === 'like') {
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          {isLoading ? (
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-gray-500 text-lg">Aucun like</p>
              <p className="text-gray-400 text-sm mt-1">Les likes reçus apparaîtront ici</p>
            </div>
          ) : (
                ...
                >
                  <div className="flex gap-4">
                    {notification.from_profile_photo ? (
                      ...
                      <div className="w-12 h-12 rounded-full flex items-center justify-center text-red-500 bg-red-50">
