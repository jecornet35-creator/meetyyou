...
const LAST_UPDATE = "2 mars 2026";
const COMPANY_NAME = "Meetyyou SAS";
const COMPANY_ADDRESS = "Paris, France";
const CONTACT_EMAIL = "legal@meetyyou.com";
const SUPPORT_EMAIL = "support@meetyyou.com";

const sections = [
  {
    id: "intro",
    title: "1. Bienvenue sur Meetyyou",
    content: `Meetyyou est une plateforme de rencontres en ligne conçue pour connecter des personnes à travers le monde. En accédant à notre application ou site web (ci-après "la Plateforme"), vous acceptez sans réserve les présentes Conditions d'Utilisation (ci-après "CGU").

Ces CGU constituent un contrat juridiquement contraignant entre vous et ${COMPANY_NAME} (ci-après "nous", "Meetyyou"). Si vous n'acceptez pas ces conditions, veuillez cesser d'utiliser la Plateforme immédiatement.
...
Nous nous réservons le droit de modifier ces CGU à tout moment. En cas de modification substantielle, nous vous en informerons par e-mail ou notification push au moins 30 jours avant l'entrée en vigueur des modifications. La poursuite de votre utilisation après notification vaut acceptation des nouvelles conditions.`
  },
  {
    ...
    content: `**Âge minimum :** Vous devez avoir au moins 18 ans révolus pour utiliser Meetyyou. En vous inscrivant, vous certifiez être majeur(e) selon la loi de votre pays de résidence. Meetyyou applique une politique de tolérance zéro à l'égard de l'utilisation de la Plateforme par des mineurs.
...
**Entreprises et organisations :** Seules les personnes physiques peuvent s'inscrire. Les entités commerciales, associations, groupes ou robots ne sont pas autorisés à créer de compte.`
  },
  {
    ...
    content: `**Création du compte :** Lors de votre inscription, vous vous engagez à fournir des informations exactes, à jour et complètes. Votre profil doit vous représenter fidèlement. Toute usurpation d'identité est strictement prohibée.

**Sécurité :** Vous êtes responsable de la confidentialité de vos identifiants de connexion. Toute activité réalisée depuis votre compte vous est imputable. Signalez immédiatement toute utilisation non autorisée de votre compte à ${SUPPORT_EMAIL}.
...
**Inactivité :** Un compte sans connexion pendant 12 mois consécutifs et sans abonnement actif peut être désactivé. Vous en serez informé par e-mail 30 jours avant.`
  },
  {
    ...
    content: `**Nature du service :** Meetyyou est une plateforme d'intermédiation sociale permettant à des adultes de se rencontrer. Nous ne sommes pas une agence matrimoniale, ni un service d'escort, ni un service de rencontres par correspondance.
...
**Algorithme de correspondance :** Meetyyou utilise un algorithme de recommandation basé sur vos préférences, votre activité et votre localisation. Cet algorithme est conçu pour vous proposer des profils pertinents, sans discrimination basée sur des critères protégés.`
  },
  {
    ...
    content: `**Tarification :** Les tarifs de nos abonnements sont affichés sur la page dédiée et incluent toutes les taxes applicables (TVA pour l'Europe). Les prix peuvent varier selon votre région de résidence.
...
**Services de paiement tiers :** Certains paiements transitent par des prestataires tiers (ex. Stripe). Leur utilisation est soumise à leurs propres conditions générales.`
  },
  {
    ...
    content: `**Utilisateurs de l'Union européenne (Directive 2011/83/UE) :**
...
Pour exercer ce droit, contactez-nous à ${CONTACT_EMAIL} avec l'objet "Rétractation - [votre email d'inscription]". Le remboursement interviendra dans les 14 jours suivant réception de votre demande.

**Utilisateurs du Royaume-Uni :**
Les droits de rétractation s'exercent dans les mêmes conditions que ceux de l'UE, conformément aux Consumer Contracts Regulations 2013.
...
**Politique générale :** En dehors des cas légaux obligatoires, les abonnements ne sont pas remboursables une fois activés et utilisés. Contactez notre support si vous estimez être victime d'une erreur de facturation.`
  },
  {
    ...
    content: `**Ce que vous vous engagez à faire :**
...
**Sanctions :** La violation de ces règles peut entraîner, selon la gravité : un avertissement, une suspension temporaire, la suppression définitive du compte et/ou un signalement aux autorités compétentes. Aucun remboursement n'est accordé en cas de résiliation pour manquement aux présentes règles.`
  },
  {
    ...
    content: `**Responsabilité :** Vous êtes seul(e) responsable du contenu que vous publiez sur la Plateforme (textes, photos, messages). Meetyyou agit en qualité d'hébergeur au sens de la loi.
...
**Notification de contrefaçon :** Pour signaler une violation de vos droits de propriété intellectuelle, contactez-nous à ${CONTACT_EMAIL} avec : votre identité, la description du contenu concerné, son emplacement sur la Plateforme et une déclaration sur l'honneur.`
  },
  {
    id: "privacy",
    title: "9. Protection des données personnelles",
    content: `**Responsable du traitement :** ${COMPANY_NAME}, ${COMPANY_ADDRESS}, est responsable du traitement de vos données personnelles.

**RGPD (Résidents UE/EEE) :** Conformément au Règlement (UE) 2016/679, vous bénéficiez des droits suivants sur vos données : accès, rectification, effacement ("droit à l'oubli"), limitation du traitement, portabilité, opposition et retrait du consentement. Pour exercer ces droits : ${CONTACT_EMAIL}.
...
**Politique de confidentialité complète :** Consultez notre Politique de Confidentialité détaillée sur la Plateforme pour l'intégralité des informations relatives au traitement de vos données.`
  },
  {
    ...
    content: `**Avertissement important :** Meetyyou met en relation des utilisateurs mais ne peut garantir l'identité, les intentions ou la véracité des informations de chaque membre. Exercez toujours votre jugement.
...
**Vérification d'identité :** Meetyyou propose un système de vérification de profil volontaire (badge "Vérifié"). Ce badge confirme une correspondance entre la photo de profil et l'identité fournie, mais ne constitue pas une enquête exhaustive sur l'utilisateur.`
  },
  {
    ...
    content: `Meetyyou applique une politique de tolérance zéro absolue envers toute forme d'abus, d'exploitation ou de contenu sexuel impliquant des mineurs (CSAM — Child Sexual Abuse Material).
...
**Coopération légale :** Meetyyou coopère sans restriction avec les autorités judiciaires dans toute enquête liée à la protection des mineurs.`
  },
  {
    ...
    content: `**Droits de Meetyyou :** La Plateforme, son code source, ses interfaces, son design, ses marques, logos, textes et fonctionnalités sont la propriété exclusive de ${COMPANY_NAME} et sont protégés par les lois françaises, européennes et internationales sur la propriété intellectuelle.
...
**Liens vers la Plateforme :** Tout lien vers notre Plateforme est autorisé dans un cadre non trompeur. Les liens présentant Meetyyou de manière erronée ou dégradante sont interdits.`
  },
  {
    ...
    content: `**Service "en l'état" :** La Plateforme est fournie "telle quelle". Nous ne garantissons pas son accessibilité continue, l'absence d'erreurs ou l'adéquation à vos attentes personnelles en matière de rencontres.
...
**Droits des consommateurs européens :** Si vous êtes un consommateur résidant dans l'UE, les garanties légales obligatoires prévues par le droit européen s'appliquent sans restriction, notamment en matière de conformité des services numériques (Directive 2019/770/UE).`
  },
  {
    ...
    content: `**Par vous :** Vous pouvez supprimer votre compte à tout moment depuis les paramètres de votre profil ou en contactant ${SUPPORT_EMAIL}. La résiliation est effective immédiatement. Les abonnements en cours ne sont pas remboursés, sauf dans les cas prévus à l'Article 6.
...
**Effets de la résiliation :** La suppression de votre compte entraîne la suppression de votre profil et de vos données, sous réserve de nos obligations légales de conservation. Vos messages envoyés à d'autres membres peuvent subsister dans leurs interfaces jusqu'à leur propre suppression.`
  },
  {
    ...
    content: `**Résolution amiable :** En cas de litige, nous vous invitons à contacter d'abord notre service client à ${SUPPORT_EMAIL}. Nous nous engageons à répondre dans les 5 jours ouvrés et à rechercher une solution amiable.
...
**Utilisateurs américains — Arbitrage obligatoire :**
Tout litige avec des résidents américains sera résolu par arbitrage individuel contraignant administré par l'American Arbitration Association (AAA) selon ses règles Consumer Arbitration Rules (www.adr.org). L'arbitrage se tiendra à New York ou à distance. Les réclamations inférieures à 5 000 USD peuvent être portées devant le tribunal des petites créances de votre comté.
...
Le droit de l'État de New York (USA) s'applique aux utilisateurs américains.`
  },
  {
    ...
    content: `**Intégralité de l'accord :** Les présentes CGU, combinées à notre Politique de Confidentialité et aux éventuelles conditions spécifiques aux services payants, constituent l'intégralité de l'accord entre vous et Meetyyou.
...
**Nous contacter :**
- Support utilisateur : ${SUPPORT_EMAIL}
- Questions légales / données personnelles : ${CONTACT_EMAIL}
- Adresse : ${COMPANY_NAME}, ${COMPANY_ADDRESS}`
  }
];
...
function Section({ section }) {
  ...
  return (
    <div className="border-b border-gray-100 last:border-0">
      ...
      >
        <span className="font-semibold text-gray-800 group-hover:text-amber-600 transition-colors text-sm md:text-base">
          {section.title}
        </span>
        {open
          ? <ChevronUp className="w-4 h-4 text-amber-500 flex-shrink-0" />
          : <ChevronDown className="w-4 h-4 text-gray-400 group-hover:text-amber-500 flex-shrink-0" />
        }
      </button>
      {open && (
        <div className="pb-5 text-sm text-gray-600 leading-relaxed space-y-3">
          {section.content.split('\n\n').map((para, i) => {
            ...
            if (para.includes('\n- ')) {
              ...
              return (
                <div key={i}>
                  {label && <p className="font-semibold text-gray-800 mb-2">{label.replace(/\*\*/g, '')}</p>}
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white">
      ...
      <div className="bg-gradient-to-r from-amber-600 to-amber-500 text-white py-12 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-3">Conditions d'Utilisation</h1>
          <p className="text-amber-100 text-sm">Dernière mise à jour : {LAST_UPDATE}</p>
          <p className="text-white/80 text-sm mt-2 max-w-xl">
            Bienvenue chez Meetyyou. Ces conditions régissent votre utilisation de notre plateforme. Prenez le temps de les lire — elles protègent à la fois vous et les autres membres de notre communauté.
          </p>
        </div>
      </div>

      <div className="max-w-3xl mx-auto px-4 py-8">
        <Link to={createPageUrl('Landing')} className="inline-flex items-center gap-2 text-amber-600 hover:text-amber-700 text-sm font-medium mb-6">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 mb-8">
          <h2 className="font-bold text-amber-800 mb-3 text-base">📋 Résumé en bref</h2>
          <ul className="space-y-1.5 text-sm text-amber-900">
            <li>✅ Vous devez avoir <strong>18 ans minimum</strong> pour utiliser Meetyyou</li>
            <li>✅ Vos informations de profil doivent être <strong>exactes et authentiques</strong></li>
            <li>✅ Respect, bienveillance et honnêteté envers les autres membres sont <strong>obligatoires</strong></li>
            <li>✅ Droit de rétractation de <strong>14 jours</strong> pour les abonnés UE (sans utilisation du service)</li>
            <li>✅ Vos données sont protégées selon le <strong>RGPD</strong> (UE) et le <strong>CCPA</strong> (Californie)</li>
            <li>✅ Tolérance <strong>zéro</strong> envers tout contenu impliquant des mineurs</li>
            <li>✅ Résolution des litiges par <strong>médiation</strong> (UE) ou <strong>arbitrage</strong> (USA)</li>
          </ul>
        </div>

        {/* Table of contents */}
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-6">
          <h2 className="font-bold text-gray-800 mb-3 text-sm uppercase tracking-wide">Table des matières</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
            {sections.map((s) => (
              <a
                key={s.id}
                href={`#${s.id}`}
                className="text-sm text-amber-600 hover:text-amber-800 hover:underline py-0.5"
              >
                {s.title}
              </a>
            ))}
        ...
        {/* Sections */}
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 px-5 md:px-8">
        ...
        <div className="mt-8 text-center text-xs text-gray-400 space-y-1">
          ...
          <p>
            ...
            <a href={`mailto:${CONTACT_EMAIL}`} className="text-amber-500 hover:underline">{CONTACT_EMAIL}</a>
          </p>
        </div>
      </div>
    </div>
