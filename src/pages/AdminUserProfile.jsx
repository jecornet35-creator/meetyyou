            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white rounded-xl shadow-sm p-6">
                <div className="grid grid-cols-3 gap-4 mb-4 pb-4 border-b">
                  ...
                  <div className="text-center">
                    <h3 className="text-sm font-semibold text-gray-900">Profil</h3>
                  </div>
                  <div className="text-center">
              ...
              <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="p-6">
                  <InfoRow 
                    ...
                    searchValue={correspondance?.education_level}
                  />
                  <InfoRow 
                    label="A des enfants" 
                    userValue={profile.has_children || 'Non'}
                    searchValue={correspondance?.has_children}
                  />
                  <InfoRow 
                    label="Alcool" 
                    userValue={translateValue(profile.drinking, 'drinking')}
                    searchValue={correspondance?.drinking?.[0]}
                  />
                  <InfoRow 
                    label="Tabac" 
                    userValue={translateValue(profile.smoking, 'smoking')}
                    searchValue={correspondance?.smoking?.[0]}
                  />
                  <InfoRow 
                    label="Religion" 
                    userValue={profile.religion}
                    searchValue={correspondance?.religion?.[0]}
                  />
                  <InfoRow 
                    label="Profession" 
                    userValue={profile.occupation}
                    searchValue={correspondance?.occupation?.[0]}
                  />
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="p-6">
                  <InfoRow 
                    ...
                    searchValue={correspondance?.hair_color?.[0]}
                  />
                  <InfoRow 
                    label="Couleur yeux" 
                    userValue={translateValue(profile.eye_color, 'eye_color')}
                    searchValue={correspondance?.eye_color?.[0]}
                  />
                  <InfoRow 
                    label="Taille" 
                    userValue={profile.height}
                    searchValue={correspondance?.height_min && correspondance?.height_max ? `${correspondance.height_min} - ${correspondance.height_max}` : null}
                  />
                  <InfoRow 
                    label="Poids" 
                    userValue={profile.weight}
                    searchValue={correspondance?.weight_min && correspondance?.weight_max ? `${correspondance.weight_min} - ${correspondance.weight_max}` : null}
                  />
                  <InfoRow 
                    label="Type de corps" 
                    userValue={translateValue(profile.body_type, 'body_type')}
                    searchValue={correspondance?.body_type?.[0]}
                  />
                  <InfoRow 
                    label="Ethnicité" 
                    userValue={translateValue(profile.ethnicity, 'ethnicity')}
                    searchValue={correspondance?.ethnicity?.[0]}
                  />
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="p-6">
                  <InfoRow 
                    ...
                    searchValue={correspondance?.family_situation?.[0]}
                  />
                  <InfoRow 
                    label="Veut des enfants" 
                    userValue={translateValue(profile.want_children, 'want_children')}
                    searchValue={correspondance?.want_children?.[0]}
                  />
                  <InfoRow 
                    label="Statut professionnel" 
                    userValue={profile.professional_status}
                    searchValue={correspondance?.professional_status?.[0]}
                  />
                  <InfoRow 
                    label="Revenu" 
                    userValue={profile.annual_income}
                    searchValue={correspondance?.annual_income_min}
                  />
                  <InfoRow 
                    label="Situation de vie" 
                    userValue={profile.living_situation}
                    searchValue={correspondance?.living_situation?.[0]}
                  />
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="p-6">
                  <InfoRow 
                    label="Nationalité" 
                    userValue={profile.nationality}
                    searchValue={correspondance?.nationality?.[0]}
                  />
                  <InfoRow 
                    label="Langues parlées" 
                    userValue={profile.languages_spoken?.join(', ')}
                    searchValue={correspondance?.languages_spoken?.join(', ')}
                  />
                  <InfoRow 
                    label="Niveau d'anglais" 
                    userValue={profile.english_proficiency}
                    searchValue={correspondance?.english_proficiency}
                  />
                  <InfoRow 
                    label="Niveau de français" 
                    userValue={profile.french_proficiency}
                    searchValue={correspondance?.french_proficiency}
                  />
                  <InfoRow 
                    label="Valeurs religieuses" 
                    userValue={profile.religious_values}
                    searchValue={correspondance?.religious_values?.[0]}
                  />
                  <InfoRow 
                    label="Polygamie" 
                    userValue={translateValue(profile.polygamy, 'polygamy')}
                    searchValue={correspondance?.polygamy?.[0]}
                  />
                </div>
              </div>
