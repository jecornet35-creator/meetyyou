...
import { MessageCircle, Bell, Settings, Heart, Users, Zap, User, Camera, Mail, Sparkles, HelpCircle, CheckCircle, Shield } from 'lucide-react';
            ...
            <div className="flex items-center gap-3 ml-4">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="start" className="w-64 bg-white p-2 shadow-xl rounded-lg border-0">
                  ...
                  <Link to={createPageUrl('PersonalityQuestions')}>
                    <DropdownMenuItem className="py-3 px-4 cursor-pointer hover:bg-gray-50 rounded text-gray-700">
                      <HelpCircle className="w-4 h-4 mr-3 text-gray-400" />
                      Questions Sur Votre Personnalité
                    </DropdownMenuItem>
                  </Link>
                  <Link to={createPageUrl('ProfileVerification')}>
                    <DropdownMenuItem className="py-3 px-4 cursor-pointer hover:bg-gray-50 rounded text-gray-700">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            <Link to={createPageUrl('Messages')}>
              <Button variant="ghost" className="text-white hover:bg-white/10 relative">
                Messages
                <Badge className="absolute -top-1 -right-1 bg-red-500 text-white text-xs px-1.5">0</Badge>
              </Button>
            </Link>
